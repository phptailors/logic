...
final class GreaterEqualTest extends TestCase
{
    ...
    {
        $this->assertExtendsClass(AbstractPredicate::class, GreaterEqual::class);
    }

    public function testUsesInfixNotationTrait(): void
    {
        $this->assertUsesTrait(InfixNotationTrait::class, GreaterEqual::class);
    }

    public function testUsesBinaryPredicateTrait(): void
    {
        $this->assertUsesTrait(BinaryPredicateTrait::class, GreaterEqual::class);
    }
